...
public class TestPriorityQueue1{
   ...
   public static void main (String[] args){
      ...
      Queue s = new LinkedPriorityQueue(2);
      //Queue s = new HeapPriorityQueue();
      ...
      Queue t, u, v, w;  
      if (s instanceof LinkedPriorityQueue){
        t = (Queue)((LinkedPriorityQueue)s).clone();
        u = (Queue)((LinkedPriorityQueue)s).clone();
        //u = new LinkedPriorityQueue(s.collectionView());
      }else{
        t = (Queue)((HeapPriorityQueue)s).clone();
        u = (Queue)((HeapPriorityQueue)s).clone();
        //u = new HeapPriorityQueue(s.collectionView());
      }
      Object[] a = s.toArray();
      System.out.println ("Expect 4 abcd : " + a.length + " " + a[0]+a[1]+a[2]+a[3]);
      System.out.println ("Expect abcd twice : " + t + u);
      if (s instanceof LinkedPriorityQueue){
        v = (Queue)((LinkedPriorityQueue)s).clone();
        //v = new LinkedPriorityQueue(s.iterator());
        w = new LinkedPriorityQueue(2);
      }else{
        v = (Queue)((HeapPriorityQueue)s).clone();
        //v = new HeapPriorityQueue(s.iterator());
        w = new HeapPriorityQueue();
      }
      w.enqueue("x"); w.enqueue("b"); w.enqueue("c"); w.enqueue("d");
      System.out.println("Expect abcd : " + v);
      v.dequeue();
