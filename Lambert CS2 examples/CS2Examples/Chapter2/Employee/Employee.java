import java.io.Serializable;      // Obtains Serializable interface
...
// Public methods
   ...
   // Precondition: 1 <= whichDay <= MAX_DAYS
   ...
   public int compareTo (Object other){
      if (! (other instanceof Employee))
         throw new IllegalArgumentException("Parameter must be an Employee");
