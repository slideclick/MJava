...
public class DiGraphs<T>
{
	 ...
	 *                  is true.
	 */
	// depth-first search. dfsList contains all the graph vertices
	 ...
	 * cycle.
	 * @param g  DiGraph
	 * @param tlist  List of visited nodes created by the algorithm.
	 *                 in an exception.
	 * @throws IllegalPathStateException if it detects a cycle when checkForCycle
	 *                  is true.
	 */
	// find a topological sort of an acyclic graph
	public static <T> void topologicalSort(DiGraph<T> g,
													LinkedList<T> tlist)
	{
		Iterator<T> graphIter;
		T vertex = null;
	 ...
	 *                  is true.
	 */
	// find the path with minimum total weight from sVertex to
	// each vertex in the graph reachable from sVertex. upon
	// return, the dataValue field of each vertex in g is either
	// the minimum path weight to the vertex or is INFINITY if the
	// vertex was not reacheable from sVertex. call
	// path(g, sVertex, v) to find the minimum path from sVertex
	// to v
	 ...
	 *                  is true.
	 */
	// in the directed acyclic graph, find the path with minimum
	// total weight from sVertex to each vertex reachable from
	// sVertex. upon return, the dataValue field of each vertex in
	// g is either the minimum path weight to the vertex or is
	// INFINITY if the vertex was not reacheable from sVertex.
	// call path(g, sVertex, v) to find the minimum path from
	// sVertex to v
	 ...
	 * cycle.
	 * @param g  DiGraph
	 * @param MST  List of visited nodes created by the algorithm.
	 * @throws IllegalPathStateException if it detects a cycle when checkForCycle
	 *                  is true.
	 */
	// find the minimum spanning tree for the connected graph g.
	// g is represented as a digraph with bidirectional edges
	// of equal weight
