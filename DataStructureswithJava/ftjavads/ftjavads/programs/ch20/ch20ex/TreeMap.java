...
public class TreeMap<K,V> implements OrderedMap<K,V>
{
   ...
   private class IteratorImpl<T> implements Iterator<T>
   {
	...
	/**
	 * Save the state of the <tt>TreeMap</tt> instance to a stream.
	...
	/**
	 * Reconstitute the <tt>TreeMap</tt> instance from a stream.
    ...
    /**
     * Returns a shallow copy of this <tt>TreeMap</tt>. (The elements
     * themselves are not cloned.)
     *
     * @return a shallow copy of this <tt>TreeMap</tt> instance.
     */
	public Object clone()
	{
		TreeMap<K,V> copy = null;

		try
		{
			copy = (TreeMap<K,V>)super.clone();
		}
