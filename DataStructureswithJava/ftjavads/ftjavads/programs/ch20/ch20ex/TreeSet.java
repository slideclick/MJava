...
public class TreeSet<T> implements OrderedSet<T>, Iterable<T>, Cloneable, java.io.Serializable
{
   ...
   private class IteratorImpl implements Iterator<T>
   {
	...
	/**
	 * Save the state of the <tt>TreeSet</tt> instance to a stream.
	...
	/**
	 * Reconstitute the <tt>TreeSet</tt> instance from a stream.
    ...
    /**
     * Returns a shallow copy of this <tt>TreeSet</tt>. (The elements
     * themselves are not cloned.)
     *
     * @return a shallow copy of this <tt>TreeSet</tt> instance.
     */
	public Object clone()
	{
		TreeSet<T> copy = null;
